...
public class AuditAspect {
	...
	public Object audit(ProceedingJoinPoint joinPoint, Auditable auditable) throws Throwable {
		...
		if (auditable.eventType() == EventType.LOGIN && args.length > 0 && args[0] instanceof LoginRequest loginRequest) {
		...
		auditLog.setEventType(auditable.eventType().toString());
		...
		try {
			...
			if (auditable.eventType() == EventType.LOGIN && result instanceof Authentication loginAuthentication) {
